...
param botEndpoint string = 'https://REPLACE-ME.azurewebsites.net/api/messages'
...
resource teamsChannel 'Microsoft.BotService/botServices/channels@2022-09-15' = {
  ...
  properties: {
    ...
    properties: {
      isEnabled: true
      // COMMERCIAL PILOT: no deploymentEnvironment override needed.
      // DoD variant sets 'FairfaxCommercialDeployment' here.
    }
  }
}
