...
@description('TPM (tokens per minute) for gpt-4o. Sub quota in eastus2 is 150 kTPM; pilot uses 100 kTPM.')
param chatTpm int = 100000

@description('TPM for text-embedding-3-large. Sub quota is 350 kTPM; pilot uses 100 kTPM.')
param embeddingsTpm int = 100000
